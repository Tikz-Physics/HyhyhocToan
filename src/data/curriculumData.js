    ...
    basicLevels: [
      {
        ...
        options: ['Hình có 3 góc nhọn', 'Hình tròn xoe như bánh xe 🟡', 'Hình có 4 cạnh bằng nhau'],
        correctAnswer: 'Hình tròn xoe như bánh xe 🟡',
      ...
      },
      {
        ...
        options: ['3 cạnh', '4 cạnh', '5 cạnh', '0 cạnh'],
      ...
      },
      {
        ...
        options: ['Có 2 cạnh dài và 2 cạnh ngắn', 'Có 3 cạnh', 'Cong tròn đều lăn được'],
        correctAnswer: 'Có 2 cạnh dài và 2 cạnh ngắn',
      ...
      },
      {
        ...
        options: ['Khối hộp chữ nhật', 'Khối lập phương', 'Hình tròn'],
